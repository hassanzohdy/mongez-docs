...
For state that should outlive the tab, use [`PlainLocalStorageDriver`](../local-storage/) instead. For state that should only live for the current page-view, use [`RunTimeDriver`](../runtime/).
