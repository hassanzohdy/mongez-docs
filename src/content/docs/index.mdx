---
title: Mongez
description: Production TypeScript packages for state, routing, forms, networking, configuration, encryption, and more — 25 focused packages, designed to read equally well to humans and AI coding agents.
template: splash
hero:
  tagline: Ship features, not boilerplate. 25 production TypeScript packages, fluent in human and AI.
  image:
...
<CardGrid>
  ...
  <Card title="Developer tooling" icon="seti:config">
